...
5. Aggiornare l'HTML guida utente corrente (`Padel_ELO_Manager_Guida_V6.7.9.html`) e la guida in formato `.md` (`ISTRUZIONI_USO.md`).
6. Eseguire i due script di generazione PDF (`node scripts/generate-team-tournament-guide-pdf.mjs` e `node scripts/generate-user-guide-pdf.mjs`) per produrre in `docs/` i PDF aggiornati della guida d'uso generica (`Guida_Uso_v6.7.9.pdf`) e della guida tornei a squadre (`Guida_Torneo_a_Squadre_v6.7.9.pdf`), rimuovendo i vecchi file PDF.
